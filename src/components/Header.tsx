  ...
  return (
    <div className="container mx-auto">
      <div className="mt-6 w-full ">
        <div className="bg-white rounded-md h-28 flex justify-between pr-12 pl-6">
          ...
          <div className="flex flex-row-reverse items-center gap-4">
            <div className=" cursor-pointer w-40 flex justify-center border border-strokeColor items-center rounded-sm h-12">
