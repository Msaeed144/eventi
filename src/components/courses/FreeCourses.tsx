...
import FreeCoursesSlider from './FreeCoursesSlider';
      ...
      <div className="mt-24 ">
        <div className="flex justify-between">
          <div className="font-semibold text-2xl relative mb-12">
            <div className="bg-tertiaryColor w-40 h-[10px] rounded-sm absolute top-5"></div>
            <h3 className="mr-1 flex gap-1 z-50 absolute w-40 text-primaryColor">
              دوره های <div className=" text-black">رایگان</div>
            </h3>
          </div>
